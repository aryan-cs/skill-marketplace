...
- **B3 · Short, catchy title + explicit contributions.** Keep the title short, catchy, and to the point. It must still be specific, accurate, and not overclaim. Prefer one clear claim or memorable phrase. Remove filler, stacked qualifiers, unnecessary subtitles, and scope details that belong in the abstract. Do not trade accuracy for cleverness. The introduction states the contributions plainly (often as a bulleted list), and they match what the paper delivers.
